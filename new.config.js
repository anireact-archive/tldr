...
module.exports = {
    ...
    homepage: (name, workspace) => `https://github.com/anireact/tldr/tree/master/${workspace}/${name}`,
    bugs: (name, workspace) => `https://github.com/anireact/tldr/issues?q=is:issue+label:${workspace}/${name}`,
    author: pkg.author,
    context: __dirname,
